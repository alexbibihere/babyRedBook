...
class EasyOCRProcessor:
    ...
    def generate_markdown(self, output_file):
        ...
        markdown = f"""# 小红书笔记图片文字识别合集 (EasyOCR)
...
if __name__ == '__main__':
    ...
    output_file = "docs/小红书笔记图片OCR识别-EasyOCR.md"
    ...
    # 创建处理器
    processor = EasyOCRProcessor(image_dir)
